 ...
 */
class Mercado extends \Application\Entity\Mercado implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\Mercado' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Mercado' . "\0" . 'descricao', '' . "\0" . 'Application\\Entity\\Mercado' . "\0" . 'usuario');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Mercado $proxy) {
