 ...
 */
class Locale extends \Application\Entity\Locale implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\Locale' . "\0" . 'codigo', '' . "\0" . 'Application\\Entity\\Locale' . "\0" . 'descricao', '' . "\0" . 'Application\\Entity\\Locale' . "\0" . 'id');
        }
