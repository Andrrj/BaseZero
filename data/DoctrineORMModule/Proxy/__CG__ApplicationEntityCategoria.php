...
class Categoria extends \Application\Entity\Categoria implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\Categoria' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Categoria' . "\0" . 'descricao', '' . "\0" . 'Application\\Entity\\Categoria' . "\0" . 'categoria');
        }
